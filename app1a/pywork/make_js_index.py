...
"""
 ...
 1 -  5   :    i,1 -  i,5
 6 - 32   :   ii,1 -  ii,27
 33 - 249 :  iii,1 -  iii,217
250 - 266 :   iv,1 -   iv,17
267 - 271 :    v,1 -    v,5
272 - 571 :   vi,1 -   vi,300
572 - 603 :  vii,1 -  vii,32
604 - 623 : viii,2 - viii,20
624 - 630 :   ix,1 -   ix,7
630 - 757 :    x,1 -    x,127
...
def pk_offset(v1,v2):
 for temp in pkdata:
  a,b,offset = temp
  if (a <= v1) and (v1 <= v2) and (v2 <= b):
   return offset
 print('pl_offset error: v1=%s, v2=%s' %(v1,v2))
 exit(1)
 
def pk_map(pagerec):
 # alter pagerec.fromv, pagerec.v2
 v1 = pagerec.fromv
 v2 = pagerec.tov
 offset = pk_offset(v1,v2)
 pagerec.fromv = v1 - offset
 pagerec.tov   = v2 - offset
